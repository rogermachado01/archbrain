...
- [Ctf Richtext](../content-rendering/ctf-richtext.md) — Renders the banner's rich text content {kind: sync}
- [Theme](../theme.md) — Sizes and colors the banner relative to the site header {kind: sync}
- [Page Link](../nav-layout/page-link.md) — Supplies the banner's call-to-action link {kind: sync}
- [Ctf Asset](../content-media/ctf-asset.md) — Supplies the banner's background asset {kind: sync}
