...
- [Ctf Richtext](ctf-richtext.md) — Renders the CTA's rich text body content {kind: sync}
- [Theme](theme.md) — Applies themed color styling to the CTA {kind: sync}
- [Page Link](page-link.md) — Resolves the CTA's click-through page link {kind: sync}
